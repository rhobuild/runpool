...
| 2026-08-29 | [Delivery fingerprints carry their encoding version](2026-08-29-delivery-fingerprints-are-versioned.md) — length-prefixed current encoding, exact historical comparison by the row's stored selector | implemented |
